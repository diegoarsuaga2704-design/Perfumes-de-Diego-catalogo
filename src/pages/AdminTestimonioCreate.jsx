...
import { createTestimonio } from "../functions/getTestimonios";
import ImageUploader from "../ui/ImageUploader";

export default function AdminTestimonioCreate() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setError("Error al guardar el testimonio. Intenta de nuevo.");
    } finally {
      setSaving(false);
    }
  }
    ...
    <div className="min-h-screen bg-gray-100">
      <header className="bg-[#2C2C2C] text-white shadow-md">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-4 flex items-center gap-4">
          ...
          <h1 className="text-lg sm:text-xl font-bold">Nuevo testimonio</h1>
        </div>
      </header>
        ...
        >
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              rows={5}
              placeholder="Texto literal del testimonio..."
